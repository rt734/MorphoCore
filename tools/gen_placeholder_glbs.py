...
def main():
    ...
    disciplines = ["karate", "kung-fu", "yoga", "calisthenics", "gym", "boxing", "muay-thai", "pilates", "judo", "wrestling", "bjj", "taekwondo", "kickboxing", "aikido", "hapkido", "krav-maga", "capoeira", "wing-chun", "silat", "arnis", "savate", "sambo", "sumo", "sanda", "tai-chi", "kalaripayattu", "muay-boran", "ninjutsu", "kendo"]
